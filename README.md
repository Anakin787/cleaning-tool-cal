...
`schedules`, `polls` 컬렉션 및 `schedules/{id}/comments` 서브컬렉션에 대한 읽기/쓰기 규칙을 설정해야 합니다.
경로: `artifacts/{appId}/public/data/schedules`, `artifacts/{appId}/public/data/polls`, `artifacts/{appId}/public/data/schedules/{scheduleId}/comments`
